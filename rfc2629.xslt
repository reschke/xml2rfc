<!--
    ...
    2003-08-15  julian.reschke@greenbytes.de
...
<xsl:template name="get-generator">
  <xsl:variable name="gen">
    ...
    <xsl:if test="contains('$Revision: 1.113 $',':')">
      <xsl:value-of select="concat('Revision ',normalize-space(translate(substring-after('$Revision: 1.113 $', 'Revision: '),'$','')),', ')" />
    </xsl:if>
    <xsl:if test="contains('$Date: 2003/08/15 20:40:51 $',':')">
      <xsl:value-of select="concat(normalize-space(translate(substring-after('$Date: 2003/08/15 20:40:51 $', 'Date: '),'$','')),', ')" />
    </xsl:if>
